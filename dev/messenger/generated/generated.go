...
type ComplexityRoot struct {
	...
	Mutation struct {
		SendMessage func(childComplexity int, recipientID string, text string) int
	}
...
type MutationResolver interface {
	SendMessage(ctx context.Context, recipientID string, text string) (*model.Message, error)
}
type QueryResolver interface {
	Inbox(ctx context.Context) ([]*model.Message, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Message.recipient":
		if e.ComplexityRoot.Message.Recipient == nil {
			break
		}

		return e.ComplexityRoot.Message.Recipient(childComplexity), true
	case "Message.sentAt":
	...
	case "Mutation.sendMessage":
		...
		return e.ComplexityRoot.Mutation.SendMessage(childComplexity, args["recipientId"].(string), args["text"].(string)), true
...
type Query {
  "Messages addressed to the current user. Requires an authenticated user."
  inbox: [Message!]!
}

type Mutation {
  "Requires messenger:messages.send."
...
func (ec *executionContext) field_Mutation_sendMessage_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "recipientId",
		func(ctx context.Context, v any) (string, error) {
			return ec.unmarshalNID2string(ctx, v)
		})
	if err != nil {
...
func (ec *executionContext) _Entity_findMessageByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *model.Message) graphql.Marshaler {
			return ec.marshalNMessage2ᚖmessengerᚋmodelᚐMessage(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Message_author(ctx context.Context, field graphql.CollectedField, obj *model.Message) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *model.User) graphql.Marshaler {
			return ec.marshalNUser2ᚖmessengerᚋmodelᚐUser(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) fieldContext_Message_recipient(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Message",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Mutation_sendMessage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().SendMessage(ctx, fc.Args["recipientId"].(string), fc.Args["text"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Message) graphql.Marshaler {
			return ec.marshalNMessage2ᚖmessengerᚋmodelᚐMessage(ctx, selections, v)
...
func (ec *executionContext) _Query_inbox(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Message) graphql.Marshaler {
			return ec.marshalNMessage2ᚕᚖmessengerᚋmodelᚐMessageᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) marshalNMessage2ᚕᚖmessengerᚋmodelᚐMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Message) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNMessage2ᚖmessengerᚋmodelᚐMessage(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNMessage2ᚖmessengerᚋmodelᚐMessage(ctx context.Context, sel ast.SelectionSet, v *model.Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNUser2ᚖmessengerᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
